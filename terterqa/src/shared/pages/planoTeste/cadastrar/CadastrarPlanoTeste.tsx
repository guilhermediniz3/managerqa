...
function CreateTestPlan() {
  ...
  // Estado para selecionar os dados dos testadores vindos do endpoint
  ...
  // Estado para selecionar os dados dos desenvolvedores vindos do endpoint
  const [selectedDeveloper, setSelectedDeveloper] = useState(null);
  // Estado para selecionar os dados dos desenvolvedores vindos do endpoint
  const [developers, setDevelopers] = useState([]);
  // Estado para selecionar os dados dos modulos vindos do endpoint
  const [selectedModulos, setSelecteModulos] = useState(null);
  // Estado para armazenar os dados dos modulos vindos do endpoint
  ...
  useEffect(() => {
    axios.get('http://localhost:8081/developers')
      .then((Response) => {
            ...
            <Tab eventKey="create-test-plan" title="Criar Plano de Teste">
              <Form onSubmit={handleSubmit}>
                ...
                <Row>
                  ...
                  <Col md={4}>
                    <Form.Group controlId="selectedModulos">
                      <Form.Label>Módulos</Form.Label>
                      <Form.Control
                        as="select"
                        value={selectedModulos || ""}
                        onChange={(e) => setSelecteModulos(Number(e.target.value))}
                      >
                        {modulos.map((modulo) => (
